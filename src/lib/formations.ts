...
export const FORMATIONS: FormationDef[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { code: "MCO", label: "Enganche derecho", validPosition: "OFFENSIVE MIDFIELDER", fieldSpot: "top-[38%] left-[72%]" },
      { code: "MCO", label: "Enganche izquierdo", validPosition: "OFFENSIVE MIDFIELDER", fieldSpot: "top-[38%] left-[28%]" },
